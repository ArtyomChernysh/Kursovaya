...
namespace RegastrationOfTheWeddingOrganizer.Settings
{
    ...
    /// </summary>
    public partial class SuitPage : Page
    {
        ...
        private void FillData(object sender, RoutedEventArgs e)
        {
            try
            {
                ...
                {
                    WorkDB.UpdateDB($"INSERT INTO Suit(Name,Cost) VALUES(N'{NameBox.Text}',N'{Convert.ToInt32(CostBox.Text)}')");
