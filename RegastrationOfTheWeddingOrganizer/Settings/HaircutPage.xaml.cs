...
namespace RegastrationOfTheWeddingOrganizer.Settings
{
    ...
    public partial class Haircut : Page
    {
        ...
        private void DeleteSelected(object sender, RoutedEventArgs e)
        {
            ...
            WorkDB.FullReupate("Haircut", users);
        }
        ...
        private void FillData(object sender, RoutedEventArgs e)
        {
            try
            {
                ...
                {
                    WorkDB.UpdateDB($"INSERT INTO Haircut(Name,Cost) VALUES(N'{NameBox.Text}',N'{Convert.ToInt32(CostBox.Text)}')");
