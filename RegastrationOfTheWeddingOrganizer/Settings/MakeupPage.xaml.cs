...
namespace RegastrationOfTheWeddingOrganizer.Settings
{
    ...
    public partial class MakeupPage : Page
    {
        ...
        private void DeleteSelected(object sender, RoutedEventArgs e)
        {
            ...
            WorkDB.FullReupate("Makeup", users);
        }
        ...
        private void FillData(object sender, RoutedEventArgs e)
        {
            try
            {
                ...
                {
                    WorkDB.UpdateDB($"INSERT INTO Makeup(Name,Cost) VALUES(N'{NameBox.Text}',N'{Convert.ToInt32(CostBox.Text)}')");
