...
namespace RegastrationOfTheWeddingOrganizer.Settings
{
    ...
    /// </summary>
    public partial class DJPage : Page
    {
        ...
        private void FillData(object sender, RoutedEventArgs e)
        {
            try
            {
                ...
                {
                    WorkDB.UpdateDB($"INSERT INTO DJ(Name,Cost) VALUES(N'{NameBox.Text}',N'{Convert.ToInt32(CostBox.Text)}')");
